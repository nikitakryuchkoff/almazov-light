...
const enDictionary = {
  ...
  contact: {
    ...
    formTopic: "Topic",
    formTopicPh: "What is this about?",
    formBrief: "Your message",
    formBriefPh: "Tell us about the task, site, timeline, or leave any note.",
    requiredFieldError: "Required field.",
    invalidEmailError: "Enter a valid email address.",
    sendBrief: "Send enquiry",
    sendingBrief: "Sending...",
    sendError: "The form could not be sent. Please try again or message us on Telegram / WhatsApp.",
