            ...
            <div className={styles.visual}>
              <div className={styles.engineering}>
                <svg
                  ...
                  opacity="0.9"
                >
                  <circle cx="80" cy="80" r="6" fill="var(--amber)" />
                  <circle cx="200" cy="40" r="6" fill="var(--amber)" />
                  <circle cx="320" cy="100" r="6" fill="var(--amber)" />
                  ...
                  <text x="12" y="14" fill="var(--amber)" fontSize="8" opacity="0.7">
                    2700K · 8W · 24°
                  </text>
                ...
                <svg viewBox="0 0 400 160" fill="none" className="scene">
                  ...
                  {[70, 120, 170, 220, 270, 320].map((x, i) => (
                    <rect
                      ...
                      width="30"
                      height="60"
                      fill={`rgb(var(--brand-rgb) / ${[0.8, 0.5, 0.9, 0.3, 0.7, 0.6][i]})`}
                    />
                  ))}
